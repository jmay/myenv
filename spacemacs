...
you should place you code here."
  ...
  (setq org-agenda-files (list
                          ...
                          "~/Dropbox/Documents/Notes/schoolistry.org"
                          ))
